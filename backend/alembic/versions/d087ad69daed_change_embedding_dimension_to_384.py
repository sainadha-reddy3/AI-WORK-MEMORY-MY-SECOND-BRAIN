...
Revision ID: d087ad69daed
Revises: a04fb872ec12
Create Date: 2026-09-22 08:35:04.591889
...
revision: str = 'd087ad69daed'
down_revision: Union[str, None] = 'a04fb872ec12'
...
def upgrade() -> None:
    ...
    op.alter_column('memory_embeddings', 'vector',
